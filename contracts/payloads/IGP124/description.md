# Establish Fluid Foundation — First Monthly Grant Transfer

## Summary

This proposal implements the on-chain action for the Fluid Foundation establishment approved via [Snapshot vote](https://snapshot.org/#/s:instadapp-gov.eth/proposal/0xde0d55050ef945d3d756219a9ee2cf29ef97c3f5625b107a65e9fd39937d6c5e): a one-time transfer of **250,000 USDC** from the DAO treasury to the Fluid Foundation. This is the first monthly disbursement under the approved $250,000/month grant program. All other components of the Foundation establishment (IP transfer, legal execution, subsequent monthly grants) are handled off-chain.
...
This proposal executes the first month's disbursement. Revenue consolidation from multi-chain sources into the Ethereum treasury and subsequent monthly grants will continue on a recurring basis per the governance approval.
...
IGP-124 transfers 250,000 USDC from the DAO treasury to the Fluid Foundation as the first monthly grant disbursement under the community-approved funding program.
