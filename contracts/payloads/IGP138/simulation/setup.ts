...
// Reserve held ~194.6 stETH at the time of writing), so the assertion below is
// the check most likely to catch a genuine problem before deployment.
...
const STETH_REQUIRED = 187n * 10n ** 18n;
...
/**
 * Action 1 withdraws 187 stETH from the Fluid Reserve. We assert rather than
