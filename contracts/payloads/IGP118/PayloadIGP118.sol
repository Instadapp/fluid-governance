...
/// @notice IGP118: Withdraw 1M GHO from Treasury for JupLend Rewards Funding
contract PayloadIGP118 is PayloadIGPMain {
    uint256 public constant PROPOSAL_ID = 118;
    ...
    /// @notice Action 1: Withdraw 1M GHO from fGHO to Team Multisig for JupLend rewards funding
    function action1() internal isActionSkippable(1) {
        ...
        // Spell 1: Withdraw 1M GHO from fGHO for JupLend rewards funding
        {
            uint256 GHO_AMOUNT = 1_000_000 * 1e18; // 1M GHO
