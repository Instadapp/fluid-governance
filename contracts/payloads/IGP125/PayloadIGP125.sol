...
/// @notice IGP125: Unpause vault 135 (wstUSR-USDC<>USDC-USDT concentrated) and set withdrawal limits
contract PayloadIGP125 is PayloadIGPMain {
    uint256 public constant PROPOSAL_ID = 125;

    function execute() public virtual override {
        super.execute();

        // Action 1: Unpause vault 135 (wstUSR-USDC<>USDC-USDT concentrated) at both DEXes and set withdrawal limits
        action1();
    }
    ...
    function action1() internal isActionSkippable(1) {
        ...
        // Step 1: Set withdrawal limits at wstUSR-USDC DEX (Pool 27) — $5M base withdrawal
        {
