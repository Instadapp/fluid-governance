 ...
 *   (e.g. IGP-132 has not been created on-chain yet). Without intervention the
 *   simulation's `propose()` could be assigned an id < 133 and revert with
 *   "PROPOSAL_IS_NOT_SAME".
 *
 ...
 *   proposal created later by the main simulation flow then lands on id 133 and
 *   passes the require check.
 *
 ...
 *     occupies the missing id and is left to expire/defeat.
 */
